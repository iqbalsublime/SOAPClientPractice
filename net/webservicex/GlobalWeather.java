 ...
 * 
 */
@WebServiceClient(name = "GlobalWeather", targetNamespace = "http://www.webserviceX.NET", wsdlLocation = "file:/D:/training/practice/InterfaceGenerator/WorldWeather1.0.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/D:/training/practice/InterfaceGenerator/WorldWeather1.0.wsdl");
